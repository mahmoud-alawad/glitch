...
import { CategoryNameInUseException } from 'server/common/exceptions/category/category-name-in-use.exception';
import { CategoryNotFoundException } from 'server/common/exceptions/category/category-not-found.exception';
import { ProductNameInUseException } from 'server/common/exceptions/product/product-name-in-use.exception';
import { ProductNotFoundException } from 'server/common/exceptions/product/product-not-found.exception';
import { PurchaseNotFoundException } from 'server/common/exceptions/purchase/purchase-not-found.exception';
import { EmailInUseException } from 'server/common/exceptions/user/email-in-use.exception';
import { UserNotFoundException } from 'server/common/exceptions/user/user-not-found.exception';
...
export class PrismaExceptionHandler implements ExceptionHandler {
   ...
   * */
  private isPrismaUnknownError(error:PrismaClientKnownRequestError): boolean {
